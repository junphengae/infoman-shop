	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				...
				<div class="right">							
				<div class="btn_box right " title="Back" onclick="javascript: window.location='sa_job_active_repaired_list.jsp?id=<%=id%>&vid=<%=vid%>&cus_id=<%=cus_id%>';">ย้อนกลับ</div>
				<div id="print" class="btn_box right">พิมพ์ใบบันทึกรายการซ่อมรถ</div>
				</div>
				<div class="clear"></div>
			</div>
					...
					<table class="bg-image s970 center">
						...
						<tbody>
							...
							<tr id="main_<%=repairLaborTime.getLabor_id()%>_<%=repairLaborTime.getNumber()%>">
								...
								<td align="center">
								<%if (repairLaborTime.getStatus().equalsIgnoreCase(RepairLaborTime.STATUS_OPENED_JOB)||(repairLaborTime.getStatus().equalsIgnoreCase(RepairLaborTime.STATUS_QT))) {%>

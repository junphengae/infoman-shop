	...
	<table width="100%" class="center" id="tb_material_add" border="0" cellpadding="4" cellspacing="4">
		<tbody>
			<tr>
				...
				<td width="75%" align="left">: <input type="text" name="labor_name" id="labor_name" class="txt_box s280 required input_focus" title="*" autocomplete="off"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left">: <input type="text" name="labor_rate" id="labor_rate" class="txt_box required" title="*" autocomplete="off"></td>
			</tr>
			<tr>

...
public class ServiceRepair {
	...
	public  static boolean check(ServiceRepair entity) throws IllegalArgumentException, SQLException, IllegalAccessException, InvocationTargetException{
	...
	/*	map.put(TYPE_WARRANTY, "Waranty");
		map.put(TYPE_REPAIR, "Repair");
		map.put(TYPE_INSURANCE, "Insurance");*/
	...
	/*	list.add(new String[]{TYPE_REPAIR,"Repair"});
		list.add(new String[]{TYPE_INSURANCE,"Insurance"});
		list.add(new String[]{TYPE_WARRANTY,"Waranty"});*/
		return list;
	}
	...
	public static void update(ServiceRepair entity) throws IllegalAccessException, InvocationTargetException, SQLException{
		Connection conn = DBPool.getConnection();
		////////System.out.println("NOTE : "+entity.getMile());

...
public class Vendor {
	...
	public  static boolean checkName(Vendor entity) throws IllegalArgumentException, SQLException, IllegalAccessException, InvocationTargetException{
		Connection conn = DBPool.getConnection();
		boolean check = false;
		check = DBUtility.getEntityFromDB(conn, tableName, entity,new String[]{"vendor_name"});
		conn.close();
		return check;
	}
	public  static boolean checkName(String vendor_name) throws IllegalArgumentException, SQLException, IllegalAccessException, InvocationTargetException{
		Vendor entity = new Vendor();
		entity.setVendor_name(vendor_name);
		return checkName(entity);
	}
	
	public static Vendor  selectcheckName(String vendor_name,String vendor_id) throws IllegalArgumentException, SQLException, IllegalAccessException, InvocationTargetException{
		Vendor entity = new Vendor();
	...
	public static Vendor selectcheckName(Vendor entity) throws IllegalArgumentException, SQLException, IllegalAccessException, InvocationTargetException{
		Connection conn = DBPool.getConnection();
		DBUtility.getEntityFromDB(conn, tableName, entity, new String[]{"vendor_name" ,"vendor_id"});
		conn.close();
		return entity;

...
public class DcpurchaseExpense {
		...
		public static DcpurchaseExpense select(DcpurchaseExpense entity) throws IllegalAccessException, InvocationTargetException, SQLException{
			Connection conn = DBPool.getConnection();
		...
		public static void insert(DcpurchaseExpense entity) throws SQLException, IllegalAccessException, InvocationTargetException{
			Connection conn = DBPool.getConnection();
		...
		public static void update(DcpurchaseExpense entity) throws SQLException, IllegalAccessException, InvocationTargetException{
			Connection conn = DBPool.getConnection();
		...
		public static List<DcpurchaseExpense> selectWithCTRL(PageControl ctrl, List<String[]> param) throws SQLException, UnsupportedEncodingException, IllegalAccessException, InvocationTargetException {
			Connection conn = DBPool.getConnection();
			String sql = "SELECT " +
							"a.*," +
			...
			List<DcpurchaseExpense> list = new ArrayList<DcpurchaseExpense>();
			...
			while (rs.next()) {
				if (cnt > max) {
					...
					if (cnt >= min) {
						DcpurchaseExpense entity = new DcpurchaseExpense();
		...
		public static DcpurchaseExpense selectForView(DcpurchaseExpense entity2) throws IllegalAccessException, InvocationTargetException, SQLException, UnsupportedEncodingException{
			Connection conn = DBPool.getConnection();
			String sql = "SELECT a.*," +
			"(SELECT g.expense_name FROM pur_expense_group g WHERE g.expense_id = a.expense_id) AS expense_name," +
			"(SELECT c.cat_name FROM pur_expense_cat c WHERE c.cat_id = a.cat_id AND c.expense_id = a.expense_id) AS cat_name," +

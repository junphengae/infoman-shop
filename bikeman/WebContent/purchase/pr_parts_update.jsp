		...
		<table cellpadding="3" cellspacing="3" border="0" class="s350 right">
			<tbody>
				...
				<tr>
					...
					<td>
						: <input type="text" autocomplete="off" name="order_qty" id="order_qty" class="txt_box required" title="ระบุจำนวนที่ต้องการสั่ง!" value="<%=pr.getOrder_qty()%>" onchange="return validNumberOnKeyUp(this, event)"> <%=UnitDesc %>  
					</td>
				</tr>
				<tr>

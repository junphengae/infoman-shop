...
<form id="other_add_form" onsubmit="return false;">
	...
	<table width="100%" class="center" id="tb_material_add" border="0" cellpadding="4" cellspacing="4">
		<tbody>
			...
			<tr>
				...
				<td align="left">: <input type="text" name="other_qty" id="other_qty" class="txt_box required" title="*" autocomplete="off" onchange="return validNumberOnKeyUp(this, event)" ></td>
			</tr>
			<tr>
				<td align="left">Price</td>
				<td align="left">: <input type="text" name="other_price" id="other_price" class="txt_box required" title="*" autocomplete="off" onblur="calculateNetPrice()" onchange="return validCurrencyOnKeyUp(this, event)"></td>
			</tr>
			<tr>
							<td align="left"><Strong>Discount % </Strong></td>
							<td align="left">: &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="discount" id="discount_percen" class="txt_box s40"  autocomplete="off"  value="0.00"  class="txt_box  " onblur="calculateDiscount()" onchange="return validCurrencyOnKeyUp(this, event)"> %
							&nbsp;&nbsp;&nbsp;
							 คิดเป็นเงิน : 
							 <span id="sod_dis2">0</span>
							 <input type="hidden" name="sod_dis" id="sod_dis" class="txt_box s40"  autocomplete="off"  value="0.00"  class="txt_box"> บาท
							</td>	
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="left">: &nbsp;&nbsp;&nbsp;&nbsp;
								<span id="sod_dis_total_txt">0</span>  บาท
								<input type="hidden" name="sod_dis_total" id="sod_dis_total" class="txt_box s40"  autocomplete="off"  value="0"  class="txt_box" >
							 </td>
						...
						<tr>
							...
							<td align="left">: &nbsp;&nbsp;&nbsp;&nbsp;
								<span id="sod_net_price_txt">0</span>  บาท
								<input type="hidden" name="sod_net_price" id="sod_net_price" class="txt_box s40"  autocomplete="off"  value="0"  class="txt_box" > </td>
	...
	$(function(){
		...
		$('#discount').keyup(function(e) {
			...
			$('#other_add_form .btn_confirm').dblclick(function() {
				return false;
				});			
	...
	<div class="txt_center m_top20">
		...
		<input type="hidden" name="vat" value="<%=ServiceOtherDetail.MISCELLANEOUS_VAT%>">

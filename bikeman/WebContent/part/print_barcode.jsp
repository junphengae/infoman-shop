...
function load(){
	setTimeout('window.print()',1000); setTimeout('window.close()',2500);
}
</script>
</head>
<body onload="load();">
	...
	<div class="barcode">
		...
		<div class="barcode_img"><img src="../../images/motoshop/barcode/<%=fileName + "--" + (sn + i)%>.png"></div>
		<div class="info">SNC Genuine Spare Part</div>
	</div>

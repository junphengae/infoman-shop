	...
	<div class="center m_top10 s600">
		<table>
			...
			<tr>
				...
				<td>: <input type="text" name="return_qty" id="return_qty" autocomplete="off" class="txt_box s150 required" title="ระบุ *" onchange="return validNumberOnKeyUp(this, event)"></td>
			</tr>
			<tr>

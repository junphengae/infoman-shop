...
public class Division {
	...
	public static List<Division> getUIObjectDivision() throws UnsupportedEncodingException, SQLException, IllegalAccessException, InvocationTargetException{
		String sql = "SELECT * FROM " + tableName + " WHERE 1=1  ORDER BY (div_id*1) ASC";

...
public class InventoryLot {
	...
	public static boolean checkSerial(InventoryLot entity) throws IllegalArgumentException, SQLException, IllegalAccessException, InvocationTargetException, UnsupportedEncodingException{
		Connection conn = DBPool.getConnection();
		boolean check = DBUtility.getEntityFromDB(conn, tableName, entity, new String[]{"serial","mat_code"});
		conn.close();
		return check;
	}

...
public class RepairLaborTerminate {
	public static final String tableName = "sv_repair_labor_terminate";
	...
	public static void insert(RepairLaborTerminate entity, Connection conn) throws IllegalAccessException, InvocationTargetException, SQLException{
		//genNum(entity, conn);
		entity.setId(DBUtility.genNumberFromDB(conn, tableName, entity, new String[]{"id"}, "num"));
		entity.setTerminate_date(DBUtility.getDBCurrentDateTime());
		DBUtility.insertToDB(conn, tableName, entity);
	}
	
	public static void genNum(RepairLaborTerminate entity, Connection conn) throws NumberFormatException, SQLException{
